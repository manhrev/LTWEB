        ...
        <div class="container-fluid h-custom">
          <div class="row d-flex justify-content-center align-items-center h-100">
            <div class="d-none d-md-block col-md-7 col-lg-6 col-xl-5">
              <img src="../../WEB-212/public/assets/others/mobile-shop.png" class="img-fluid" alt="Sample image">
            </div>
            <div class="col-md-5 col-lg-6 col-xl-4 offset-xl-1">
              <form accept-charset="UTF-8" action="./Signup/signup" method="post">
                ...
                <div class="form-outline mb-2">
                  <input type="text" class="form-control form-control-lg" placeholder="Enter your full name" name="fullname" required />
                ...
                <!-- Phone input -->
                <div class="form-outline mb-2">
                  <input type="tel" class="form-control form-control-lg" placeholder="Enter a valid phone number" name='phone' required />
                ...
                <div class="text-center text-lg-start mt-4 pt-2">
                  ...
                  <p class="small fw-bold mt-2 pt-1 mb-0">Already have an account? <a href="#!" class="link-danger">Login here</a></p>
                </div>
