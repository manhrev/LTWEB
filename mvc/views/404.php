                    ...
                    <div class="container">
                        <div class="row center">
                            <div class="content-404 col-lg-6 col-sm-6 text-center">
                                <div class="image">
                                    <img class="img-fluid" src="<?=STATIC_URL?>img/other/image-404.png" alt="Image 404">
                                </div>
                                <h2 class="h4">Xin lỗi, trang mà bạn yêu cầu không tồn tại.</h2>
                                <div class="info">
                            ...
                            <div class="content-right-404 col-lg-6 col-sm-6 text-center">
                                <a href="#">
                                    <img class="img-fluid" src="<?=STATIC_URL?>img/other/background.jpg" alt="image 404 right">
                                </a>
                            </div>
                        </div>
                    </div>
